...
const SCHEMAS = [{
    name: "sid", // - (String) The schedule ID.
    validate: (value) => {
...
exports.handler = async(event, context) => {
  ...
  Item.deviceid = { S: schedules.Items[0].deviceid.S }
  Item.enabled = { BOOL: schedules.Items[0].enabled.BOOL }
  await dynamo
    .putItem({
      TableName: "schedule",
      Item,
  ...
  schedule.sid = sid;
  schedule.deviceid = schedules.Items[0].deviceid.S
